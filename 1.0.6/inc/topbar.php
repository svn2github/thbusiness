		...
		<div class="row">
			<div class="col-md-6 col-xs-12 col-sm-12">
				<?php if(of_get_option('thbusiness_telephone_text','') || of_get_option('thbusiness_telephone_num','')) { 
					...
					?>
					<div class="topbar-icon"><i class="fa fa-phone"></i></div><?php echo $tp_text . ' ' . $tp_num ?>
				<?php } ?>
				<?php if(of_get_option('thbusiness_email_text','') || of_get_option('thbusiness_email_add','')) { 
					...
					?>
					<div class="topbar-icon"><i class="fa fa-envelope"></i></div><?php echo $email_text; ?><a href="mailto:<?php echo $email_add; ?>" target="_top"> <?php echo $email_add; ?></a>
				<?php } ?>
