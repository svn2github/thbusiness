...
function thbusiness_setup() {
	...
	add_image_size( 'featured-large', 720, 540, true ); 
...
function thbusiness_load_fonts() {
	wp_register_style('googleWebFonts', 'http://fonts.googleapis.com/css?family=PT+Sans:400,700');
...
* Add flex slider.
*/
function thbusiness_flex_header() {

    wp_register_script( 'add-flex-custom-js', get_template_directory_uri() . '/js/jquery.flexslider-min.js', array(), null, '', true );
...
add_action( 'wp_enqueue_scripts', 'thbusiness_flex_header' );
...
/**
 * Setup Theme Options Panel to TH-Business Theme.
 */
