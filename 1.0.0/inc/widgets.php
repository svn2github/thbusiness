...
class Thbusiness_Services_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			__( 'TH-Business Services Widget', 'thbusiness' ), // Name
	...
	?>
		<?php _e( 'If there is not a icon it will display the featured image of the page as the icon.', 'thbusiness' ); ?>
		<?php for( $i=0; $i<6; $i++) { ?>
		<?php $j = $i+1; ?>
			<p>
			...
			<div class="<?php echo $class; ?>">
				<div class="th-services-box">
					...
					<article class="th-front-page-summery">
						<?php echo thbusiness_excerpt(30); ?>
					</article>
...
class Thbusiness_RecentWork_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			__( 'TH-Business Recent Work Widget', 'thbusiness' ), // Name
...
class Thbusiness_CallTo_Action extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			__( 'TH-Business Call To Action', 'thbusiness' ), // Name
...
class Thbusiness_SinglePage_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			__( 'TH-Business Single Page Widget', 'thbusiness' ), // Name
...
class Thbusiness_Testimonial_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			__( 'TH-Business Testimonial', 'thbusiness' ), // Name
...
class Thbusiness_Featured_Images extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			__( 'TH-Business Featured Images', 'thbusiness' ), // Name
